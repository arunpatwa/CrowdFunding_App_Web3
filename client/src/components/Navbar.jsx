...
const Navbar = () => {
  ...
  //usestate hooks using to change initialise and change the state
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      {/* below div is for the search box */}
      ...
      {/* below is different div using for the connecting the wallet  */}
